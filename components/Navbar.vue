...
const { isAuth, user, signOut } = authStore();
  ...
  <div class="bg-Light sticky top-0 z-10">
    ...
    >
      ...
      <NuxtLink href="/" class="flex items-center">
        <img
          src="@/assets/css/images/Oldies_Logo.png"
          class="h-10 mr-3"
          alt="Logo OLDIES"
        />
        <span
          class="self-center text-lg font-semibold whitespace-nowrap text-Primary"
          >OLDIES</span
        >
      </NuxtLink>
      ...
      <div class="flex grow px-4">
        <label
          for="search-dropdown"
          class="mb-2 text-sm font-medium text-Dark sr-only hidden lg:flex"
          >Your Email</label
        >
        <button
          id="dropdown-button"
      ...
      <div class="hidden w-full lg:block lg:w-auto" id="navbar-search">
        <div class="flex">
          <label
            for="search-dropdown"
            class="mb-2 text-sm font-medium text-Dark sr-only flex lg:hidden"
            >Your Email</label
          >
          <button
            id="dropdown-button"
      ...
      <div class="hidden w-full lg:block lg:w-auto" id="navbar-dropdown">
        ...
        >
          ...
          <li class="mt-1 self-center" v-show="!isAuth">
            <NuxtLink
              to="/login"
          ...
          <li class="self-center" v-show="!isAuth">
          ...
          <li class="flex items-center md:order-2 self-center" v-show="isAuth">
            <button
              type="button"
